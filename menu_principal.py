...
import util.posicionar_ventana as pv
...
class MenuEmssamlud(Toplevel):
    ...
    def crear_frame_paciente(self):
        ...
        self.cuadro_dni_paciente = Entry(self.frame_registro_pacientes, font=('Times New Roman', 10, 'bold'), state=DISABLED)
        self.cuadro_dni_paciente.grid(row=0, column=1)
        self.cuadro_nombres_paciente = Entry(self.frame_registro_pacientes, font=('Times New Roman', 10, 'bold'), state=DISABLED)
        self.cuadro_nombres_paciente.grid(row=1, column=1)
        self.cuadro_apellido_paterno_paciente = Entry(self.frame_registro_pacientes, font=('Times New Roman', 10, 'bold'), state=DISABLED)
        self.cuadro_apellido_paterno_paciente.grid(row=2, column=1)
        self.cuadro_apellido_materno_paciente = Entry(self.frame_registro_pacientes, font=('Times New Roman', 10, 'bold'), state=DISABLED)
        self.cuadro_apellido_materno_paciente.grid(row=3, column=1)
        self.cuadro_telefono_paciente = Entry(self.frame_registro_pacientes, font=('Times New Roman', 10, 'bold'), state=DISABLED)
        self.cuadro_telefono_paciente.grid(row=4, column=1)

        #self.fecha = StringVar()
        self.cuadro_fecha_nacimiento_paciente = DateEntry(self.frame_registro_pacientes, locale='es_ES', date_pattern='dd/MM/yyyy')
        ...
        self.cuadro_direccion_paciente = Entry(self.frame_registro_pacientes, font=('Times New Roman', 10, 'bold'), width=25, state=DISABLED)
        self.cuadro_direccion_paciente.grid(row=1, column=3, padx=(20, 0), sticky=W)
        
        self.estado_sexo = False
        self.cuadro_sexo_paciente = ttk.Combobox(self.frame_registro_pacientes, state=DISABLED, values=['Masculino', 'Femenino'], font=('Times New Roman', 10, 'bold'), width=23)
        self.cuadro_sexo_paciente.grid(row=2, column=3, padx=(20, 0), sticky=W)
        self.cuadro_sexo_paciente.set('Seleccione su sexo')
        
        self.cuadro_email_paciente = Entry(self.frame_registro_pacientes, font=('Times New Roman', 10, 'bold'), width=25, state=DISABLED)
        ...
        self.cuadro_observacion = Text(self.frame_obs, font=('Times New Roman', 10, 'bold'), width=25, height=3.5, state=DISABLED)
        ...
        def deshabilitar_campos():
            ...
            mes_fecha_seleccionada(self.fecha_actual), dia_fecha_seleccionada(self.fecha_actual)))
            self.cuadro_direccion_paciente.delete('0', 'end')
            self.cuadro_sexo_paciente.set('Seleccione su sexo')
            self.cuadro_email_paciente.delete('0', 'end')
            self.cuadro_observacion.delete('1.0', 'end')
        ...
        def registrar():
            ...
            or not self.cuadro_direccion_paciente.get() or self.cuadro_sexo_paciente.get() == 'Seleccione su sexo'):
                ...
                messagebox.showwarning('Advertencia', 'Verifique el DNI y el número telefónico ingresados (solo dígitos).')
            elif self.error_ingreso_dni == True and len(self.cuadro_telefono_paciente.get()) != 9:
                messagebox.showwarning('Advertencia', 'Verifique el DNI (solo dígitos) y el número telefónico ingresado (9 dígitos).')
            elif len(self.cuadro_dni_paciente.get()) != 8 and self.error_ingreso_telefono == True:
                messagebox.showwarning('Advertencia', 'Verifique el DNI (8 dígitos) y el número telefónico ingresado (solo dígitos).')
                ...
                messagebox.showwarning('Advertencia', 'Verifique el DNI (8 dígitos) y el número telefónico ingresados (9 dígitos).')
                ...
                self.cuadro_apellido_paterno_paciente.get(), self.cuadro_apellido_materno_paciente.get(),
                self.cuadro_telefono_paciente.get(), self.lista_fechas[len(self.lista_fechas)-1],
                self.cuadro_direccion_paciente.get(), self.cuadro_sexo_paciente.get(),
                self.cuadro_email_paciente.get(), self.cuadro_observacion.get(1.0, "end-1c").replace('\n', ' '))
        ...
        self.opcion_nuevo_paciente = Button(self.frame_opciones_registro_pacientes, text='Nuevo', cursor='hand2', command=nuevo)
        self.opcion_nuevo_paciente.grid(row=0, column=0, padx=70)

        self.opcion_registrar_paciente = Button(self.frame_opciones_registro_pacientes, text='Registrar', cursor='hand2', command=registrar, state=DISABLED)
        self.opcion_registrar_paciente.grid(row=0, column=1, padx=70)

        self.opcion_modificar_paciente = Button(self.frame_opciones_registro_pacientes, text='Modificar', cursor='hand2', command=modificar, state=DISABLED)
        self.opcion_modificar_paciente.grid(row=0, column=2, padx=70)

        self.opcion_eliminar_paciente = Button(self.frame_opciones_registro_pacientes, text='Eliminar', cursor='hand2', command=eliminar, state=DISABLED)
        ...
        def tabla_pacientes():
            ...
            for dato in datos_paciente:
                ...
                dato[3], dato[4], dato[5], dato[6], dato[7], dato[8], dato[9], dato[10]))
            ...
            def paciente_seleccionado(event):
                ...
                mes_fecha_seleccionada(fecha_nacimiento_paciente), dia_fecha_seleccionada(fecha_nacimiento_paciente)))
                self.cuadro_direccion_paciente.delete('0', 'end')
    ...
    def crear_frame_personal_salud(self):
        ...
        self.label_ocupacion = Label(self.frame_registro_personal_salud, text='Ocupación', font=('Times New Roman', 10, 'bold'), height=3, bg='#0EB06E')
        ...
        self.especialidad = Label(self.frame_registro_personal_salud, text='Especialidad', font=('Times New Roman', 10, 'bold'), height=3, bg='#0EB06E')
        self.especialidad.grid(row=3, column=2, padx=(100, 20), sticky=W)
        self.area = Label(self.frame_registro_personal_salud, text='Area', font=('Times New Roman', 10, 'bold'), height=3, bg='#0EB06E')
        self.area.grid(row=4, column=2, padx=(100, 20), sticky=W)
        
        self.cuadro_dni_personal_salud = Entry(self.frame_registro_personal_salud, font=('Times New Roman', 10, 'bold'), state=DISABLED)
        self.cuadro_dni_personal_salud.grid(row=0, column=1)
        self.cuadro_nombres_personal_salud = Entry(self.frame_registro_personal_salud, font=('Times New Roman', 10, 'bold'), state=DISABLED)
        self.cuadro_nombres_personal_salud.grid(row=1, column=1)
        self.cuadro_apellido_paterno_personal_salud = Entry(self.frame_registro_personal_salud, font=('Times New Roman', 10, 'bold'), state=DISABLED)
        self.cuadro_apellido_paterno_personal_salud.grid(row=2, column=1)
        self.cuadro_apellido_materno_personal_salud = Entry(self.frame_registro_personal_salud, font=('Times New Roman', 10, 'bold'), state=DISABLED)
        self.cuadro_apellido_materno_personal_salud.grid(row=3, column=1)
        self.cuadro_telefono_personal_salud = Entry(self.frame_registro_personal_salud, font=('Times New Roman', 10, 'bold'), state=DISABLED)
        ...
        self.cuadro_ocupacion = ttk.Combobox(self.frame_registro_personal_salud, values=['Médico', 'Enfermero'], font=('Times New Roman', 10, 'bold'), width=22, state=DISABLED)
        ...
        self.estado_sexo = False
        self.cuadro_sexo_personal_salud = ttk.Combobox(self.frame_registro_personal_salud, values=['Masculino', 'Femenino'], font=('Times New Roman', 10, 'bold'), width=22, state=DISABLED)
        ...
        self.cuadro_disponibilidad = ttk.Combobox(self.frame_registro_personal_salud, values=['Mañana', 'Tarde', 'Noche'], font=('Times New Roman', 10, 'bold'), width=22, state=DISABLED)
        ...
        self.estado_especialidad = False
        self.cuadro_especialidad = ttk.Combobox(self.frame_registro_personal_salud, values=['Cardiología', 'Odontología', 'Traumatología'], font=('Times New Roman', 10, 'bold'), width=22, state=DISABLED)
        self.cuadro_especialidad.set('Seleccione su especialidad')
        self.cuadro_especialidad.grid(row=3, column=3, padx=(20, 0), sticky=W)
        self.estado_area = False
        self.cuadro_area = ttk.Combobox(self.frame_registro_personal_salud, values=['Pediatría', 'Salud mental', 'Emergencias'], font=('Times New Roman', 10, 'bold'), width=22, state=DISABLED)
        self.cuadro_area.set('Seleccione su área')
        ...
        self.opcion_nuevo_personal_salud = Button(self.frame_opciones_registro_personal_salud, text='Nuevo', cursor='hand2')
        self.opcion_nuevo_personal_salud.grid(row=0, column=0)

        self.opcion_registrar_personal_salud = Button(self.frame_opciones_registro_personal_salud, text='Registrar', cursor='hand2')
        self.opcion_registrar_personal_salud.grid(row=0, column=1)

        self.opcion_modificar_personal_salud = Button(self.frame_opciones_registro_personal_salud, text='Modificar', cursor='hand2')
        self.opcion_modificar_personal_salud.grid(row=0, column=2)

        self.opcion_eliminar_personal_salud = Button(self.frame_opciones_registro_personal_salud, text='Eliminar', cursor='hand2')
        ...
        def registrar():
            ...
            or self.cuadro_sexo_personal_salud.get() == 'Seleccione su sexo' and self.cuadro_disponibilidad.get() == 'Seleccione su disponibilidad'):
                ...
                if self.estado_especialidad == True:
                    medico = personal.Medico(self.cuadro_dni_personal_salud.get(), self.cuadro_nombres_personal_salud.get(),
                    self.cuadro_apellido_paterno_personal_salud.get(), self.cuadro_apellido_materno_personal_salud.get(),
                    self.cuadro_telefono_personal_salud.get(), self.cuadro_ocupacion.get(),
                    self.cuadro_sexo_personal_salud.get(), self.cuadro_disponibilidad.get(), self.cuadro_especialidad.get())
                    admin.registrar_med(medico)
                    tabla_medicos()
                else:
                    enfermero = personal.Enfermero(self.cuadro_dni_personal_salud.get(), self.cuadro_nombres_personal_salud.get(),
                    self.cuadro_apellido_paterno_personal_salud.get(), self.cuadro_apellido_materno_personal_salud.get(),
                    self.cuadro_telefono_personal_salud.get(), self.cuadro_ocupacion.get(),
                    self.cuadro_sexo_personal_salud.get(), self.cuadro_disponibilidad.get(), self.cuadro_area.get())
        ...
        def modificar():
            ...
            or not self.cuadro_apellido_materno_personal_salud.get() or len(self.cuadro_telefono_personal_salud.get()) == 0
        ...
        self.opcion_nuevo_personal_salud = Button(self.frame_opciones_registro_personal_salud, text='Nuevo', cursor='hand2', command=nuevo)
        self.opcion_nuevo_personal_salud.grid(row=0, column=0, padx=70)

        self.opcion_registrar_personal_salud = Button(self.frame_opciones_registro_personal_salud, text='Registrar', cursor='hand2', command=registrar, state=DISABLED)
        self.opcion_registrar_personal_salud.grid(row=0, column=1, padx=70)

        self.opcion_modificar_personal_salud = Button(self.frame_opciones_registro_personal_salud, text='Modificar', cursor='hand2', command=modificar, state=DISABLED)
        self.opcion_modificar_personal_salud.grid(row=0, column=2, padx=70)

        self.opcion_eliminar_personal_salud = Button(self.frame_opciones_registro_personal_salud, text='Eliminar', cursor='hand2', command=eliminar, state=DISABLED)
        ...
        def tabla_medicos():
            ...
            'Apellido paterno', 'Apellido materno', 'Teléfono', 'Ocupación', 'Sexo',
            ...
            for dato in datos_medico:
                ...
                dato[3], dato[4], dato[5], dato[6], dato[7], dato[8], dato[9]))
        ...
        self.ver_tabla_enfermero = Button(self.frame_tablas, text='Tabla Enfermero', cursor='hand2', command=tabla_enfermeros)
    ...
    def ventana_inicio(self):
        ...
        self.label_pacientes = Label(self.frame_opciones_inicio, text='Pacientes', font=('Times New Roman', 18, 'bold'), bg='#0EB06E')
        ...
        Button(self.frame_opciones_inicio, image=self.imagen_pacientes, bg='#9DE8E2', command=self.crear_frame_paciente, cursor='hand2').grid(row=1, column=0, padx=60)
        ...
        Button(self.frame_opciones_inicio, image=self.imagen_medicos, bg='#9DE8E2', command=self.crear_frame_personal_salud, cursor='hand2').grid(row=1, column=1)
    ...
    def crear_frame_agendar_cita(self):
        ...
        'Apellido paterno', 'Apellido materno', 'Teléfono', 'Fecha de nacimiento', 'Dirección', 'Sexo',
        ...
        for i in range(5):
            self.tabla_personal_salud.insert('', END, text=i, values=(i+10, i+20, i+30, i+40, i+50, i+60, i+70, i+80, i+90, i+100))

        self.scroll_vertical_tabla_personal_salud = Scrollbar(self.frame_agendar_cita, command=self.tabla_personal_salud.yview)
    ...
    def crear_frame_atender_cita(self):
        ...
        self.label_id_cita = Label(self.frame_atender_cita, text='ID cita', font=('Times New Roman', 10, 'bold'), height=3, bg='#0EB06E')
        self.label_id_cita.grid(row=0, column=0, padx=(10, 0), sticky=W)

        self.label_fecha = Label(self.frame_atender_cita, text='Fecha', font=('Times New Roman', 10, 'bold'), height=3, bg='#0EB06E')
        self.label_fecha.grid(row=1, column=0, padx=(10, 0), sticky=W)

        self.label_sintomas = Label(self.frame_atender_cita, text = 'Síntomas',font=('Times New Roman', 10,'bold'),height=3,bg='#0EB06E')
        self.label_sintomas.grid(row=0,column=2,padx=(10,0),stick=W)

        self.label_medicamento = Label(self.frame_atender_cita, text = 'Medicamento',font=('Times New Roman', 10,'bold'),height=3,bg='#0EB06E')
        self.label_medicamento.grid(row=4,column=2,padx=(10,0),stick=W)

        self.label_diagnostico = Label(self.frame_atender_cita, text = 'Diagnostico',font=('Times New Roman', 10,'bold'),height=3,bg='#0EB06E')
        ...
        self.cuadro_medicamentos = Text(self.frame_atender_cita, font=('Times New Roman', 10, 'bold'), width=20, height=3.5)
        self.cuadro_medicamentos.grid(row=4, column=3,padx=(10,0), sticky=W)

        self.cuadro_diagnostico = Text(self.frame_atender_cita, font=('Times New Roman', 10, 'bold'), width=20, height=3.5)
        ...
        self.tabla_atender_cita = ttk.Treeview(self.frame_atender_cita, columns=('ID cita','Nombres','Apellido paterno','Apellido materno','Fecha','Sintomas','Medicamento','Diagnostico','Email','Disponibilidad'), height=3)
        ...
        for i in range(5):
            self.tabla_atender_cita.insert('', END, text=i, values=(i+10, i+20, i+30, i+40, i+50, i+60, i+70, i+80, i+90, i+100))

        self.scroll_vertical_tabla_atender_cita = Scrollbar(self.frame_atender_cita, command=self.tabla_atender_cita.yview)
    ...
    def menu_opciones(self):
        ...
        self.boton_agendar_cita = Button(self.ventana_principal, image=self.imagen_opcion_agendar_cita, command=self.crear_frame_agendar_cita, cursor='hand2', height=38, width=98)
        ...
        self.boton_atender_cita = Button(self.ventana_principal, image=self.imagen_opcion_atender_cita, command=self.crear_frame_atender_cita, cursor='hand2', height=38, width=98)
