...
class Login(Tk):
    def __init__(self) -> None:
        ...
        utl.centrar_ventana(self, 450, 600)
    ...
    def ingresar_sistema(self):
        self.withdraw()
        self.ventana_principal = menu_principal.MenuEmsamlud()
    ...
    def disenno_interfaz_login(self):
        ...
        self.cuadro_usuario.pack(pady=(0, 20), padx=(15, 0))
        ...
        self.cuadro_usuario.grid(row=0, column=1, sticky=S, padx=(5, 0))
