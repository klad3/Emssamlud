...
class Login(Tk):
    def __init__(self):
        ...
        self.protocol("WM_DELETE_WINDOW", self.fin_login)
        self.admin = adm.Admin()

    def ingresar_sistema(self):
        self.admin.login(self.usuario.get(), self.password.get())

        if self.admin.accede_sistema:
            self.withdraw()
            self.ventana_principal = m.MenuEmssamlud()
            self.ventana_principal.protocol("WM_DELETE_WINDOW", self.fin_programa)

    def fin_login(self):
        self.destroy()
        self.admin.finalizar_conexion_db()
    ...
    def disenno_interfaz_login(self):
        ...
        Label(self.cuadro_titulo_login, text='ACCESO', font=('Times New Roman', 18, BOLD), bg='#9DE8E2',
              fg='#0EB06E').pack()
        ...
        self.cuadro_usuario = Entry(self.cuadro_usuario, bg='#9DE8E2', fg='#0EB06E', font=18, highlightthickness=1,
                                    highlightbackground='#9DE8E2', highlightcolor='#9DE8E2', textvariable=self.usuario,
                                    width=20)
        ...
        self.cuadro_password = Entry(self.frame_password, bg='#9DE8E2', fg='#0EB06E', font=18, show='•',
        ...
        self.boton_mostrar_password = Button(self.frame_password, image=self.imagen_mostrar_password,
                                             command=mostrar_password, bg='#9DE8E2')
        ...
        self.boton_ingresar = Button(self.cuadro_boton, text='Ingresar', bg='#9DE8E2', command=self.ingresar_sistema,
                                     cursor='hand2')
